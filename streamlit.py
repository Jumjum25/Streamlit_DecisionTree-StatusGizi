...
# Judul aplikasi
st.title('Klasifikasi Status Gizi Anak dengan Algoritma Decision Tree')
...
if uploaded_file is not None:
    ...
    if page == "Home":
        ...
        # Pastikan class_names sesuai dengan label yang ada di y_test dan y_pred
        class_report = classification_report(y_test, y_pred, labels=range(len(class_names)), target_names=class_names)
        ...
        # Visualisasi confusion matrix untuk target yang ada
